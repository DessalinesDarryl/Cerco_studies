...
Métriques visualisées (une figure par canal x métrique, soit 5x4 = 20 figures) :
...
OUTPUT_FIGS  = r"c:\dev\Cerco_studies\data\visualisation\emg\boxplots"
OUTPUT_STATS = r"c:\dev\Cerco_studies\data\visualisation\emg\stats"
...
def _make_boxplot(sub_f, channel, metric, kw_p, pw, plt, sns):
    ...
    sns.boxplot(data=sub_f, x="group", y="value", order=order,
                palette=PALETTE, showfliers=False, ax=ax, legend=False)
    sns.stripplot(data=sub_f, x="group", y="value", order=order,
